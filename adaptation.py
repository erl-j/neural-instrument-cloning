...
pretrained_checkpoint_path="./artefacts/training/Saxophone/ckpt-250000"
finetune_whole=True
...
for train_data_duration in TRAIN_DATA_DURATIONS:
    ...
    while epoch_count<n_epochs:
        ...
        with trn_summary_writer.as_default():
            tf.summary.scalar('loss', epoch_loss/batch_counter, step=epoch_count*BATCH_SIZE*n_batches)
        with tst_summary_writer.as_default():
            tf.summary.scalar('loss', tst_epoch_loss/tst_batch_counter, step=epoch_count*BATCH_SIZE*n_batches)
