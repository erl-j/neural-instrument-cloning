...
def get_model(SAMPLE_RATE,CLIP_S,FT_FRAME_RATE,Z_SIZE,N_INSTRUMENTS,IR_DURATION,BIDIRECTIONAL,USE_F0_CONFIDENCE,N_HARMONICS,N_NOISE_MAGNITUDES,losses=[]):
    ...
    harmonic_plus_fn= ddsp.processors.Add(name='harmonic_plus_fn')
    wet_gain_plus_dry_gain = ddsp.processors.Add(name='wet_gain_plus_dry_gain')
    ...
    (reverb, ["harmonic_plus_fn/signal","ir"]),
    (wet_gain,["reverb/signal","wet_gain"]),
    (dry_gain,["harmonic_plus_fn/signal","dry_gain"]),
